...
SET SERVEROUTPUT ON
DECLARE
  FUNCTION CREATE_CLIENT_2(p_CUSTOMER_NAME IN VARCHAR2, p_CUSTOMER_SURNAME IN VARCHAR2, p_WAREHOUSE_ID IN NUMBER)
    RETURN NUMBER
  IS
    v_NEW_CUSTOMER_ID NUMBER;
    v_NEW_ORDER_ID NUMBER;
    v_ROW_WAREHOUSES  WAREHOUSES%ROWTYPE;
    BEGIN
      BEGIN
      ...
      INSERT INTO ORDERS O(O.CUSTOMER_ID,O.ORDER_DATE)
      VALUES(NEW_CUSTOMER_ID,SYSDATE)
      RETURNING ORDER_ID INTO v_NEW_ORDER_ID;
      ...
      WHERE W.WAREHOUSE_ID=v_WAREHOUSE_ID) LOOP
        INSERT INTO ORDER_ITEMS OI(OI.ORDER_ID,OI.PRODUCT_ID)
        VALUES(NEW_ORDER_ID,i_REC.PRODUCT_ID);
      END LOOP;
      RETURN v_NEW_CUSTOMER_ID;
    END;
...
BEGIN
  DBMS_OUTPUT.ENABLE;
  DBMS_OUTPUT.PUT_LINE(CREATE_CLIENT_2('NET', 'CRACKER',5));
END;
